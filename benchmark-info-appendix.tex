...
Excepting the benchmarks in \Autoref{ch:rewriting,ch:reification-by-parametricity} and \autoref{ch:appendix:rewriting}, all of the benchmarks can be found in the GitHub repository \url{https://github.com/JasonGross/doctoral-thesis} in the folders \texttt{performance-experiments} and \texttt{performance-experiments-8-9}.
