...
In this thesis, we present design principles in \autoref{part:design} to avoid these performance bottlenecks, and insights about the proof-checking system that the performance bottlenecks reveal.
We present a research prototype of a tool and methodology for achieving acceptable performance at scale in \autoref{part:rewriting}. 
