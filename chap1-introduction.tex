...
\todo{wide look at various proof assistants (historical overview of how the field got to where it is today, maybe with weight according to importance) and successes (applications of proof assistants like compcert~\cite{Compcert}, sel4 (kernel)~\cite{seL4SOSP09}, cakeml~\cite{CakeML}, nqthm~\cite{Nqthm,wiki:Nqthm}, ACL2~\cite{ACL2,ACL2Applications}, crypto???, flyspeck~\cite{flyspeck,flyspeck2014Hales}, 4-color-theorem~\cite{gonthier2008formal}, odd-order-theorem~\cite{gonthier2013machine})}
