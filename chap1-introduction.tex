...
While small bugs can cost hours or days of developer time, other bugs have more severe costs in money or even lives.
Intel lost about \$475 million when it recalled chips impacted by a minor bug in the lookup table implementing floating-point division~\todo{cite}.
NASA lost hardware costing over \$500 million due to bugs in rocket software that created unrecoverable errors~\todo{cite three rocket issues}.
...
Finally, the Therac-25 radiation therapy machine killed three people and injured more by delivering dangerous doses of radiation~\wantclear[\textcolor]{\cite{Therac}}.
...
\todo{email Xavier Leroy and ask if he has references on how much the airline industry spends on testing}
...
\todo{Ask readers for feedback on readability, design choices of this paragraph in particular}
...
\todo{Work in justification of dependent types ``Randy Pollack, On extensibility of proof checkers, Types for Proofs
...
\todo{read Grégoire and Leroy's paper from ICFP 2002 \textcite{vmcompute}}
