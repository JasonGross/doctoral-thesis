...
The creation of the company Thusted Logic, specialized in the certification of smart-card-based system using technologies adapted from the Caml and Coq teams, confirmed the relevance of their research.
...
\todo{Next paragraph talks about LEGO (which comes before Coq, makes same foundational decisions, email Randy Pollack(sp?) creator of LEGO, to get historical context), Coq, (+Agda, etc), (innovation: Martin Löf, proof checking is type checking)}
