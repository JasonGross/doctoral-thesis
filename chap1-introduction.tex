...
\todo{a couple sentences about tactics}
\todo{a paragraph or two summarized from Coq'Art on Martin-Lof and Coq, and LEGO from email to Pollack}
\todo{a pargaraph mentioning other significant proof checkers, perhaps a sentence each, and also mentioning achievements in those provers}
