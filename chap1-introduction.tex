...
However, in all examples of software verification successes, there is an enormous overhead in the lines of proof written over the lines of code being verified. The proof is so exorbitant and arduous that it typically requires multiple PhDs worth of work to verify one piece of software. 
\todo{Insert graph}
