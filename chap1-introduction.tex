...
Notably, it was based on the Calculus of Constructions (CoC), a synthesis of Martin-L\"of's type theory\todo{cite} with dependent types and polymorphism, which grew out of Dana Scott's logic of computable functions\todo{cite} together with de Bruijn's work on Automath\todo{cite}~\cite{CoqArtForward2013Huet}.
