...
Bugs are ways in which the actual behavior of software diverges from the intended behavior.
While small bugs can cost hours or days of developer time, other bugs have more severe costs in money or even lives.
Bugs in the software of the Therac-25, a radiation-therapy machine, killed three people and injured at least three more between 1985 and 1987 by delivering potentially lethal doses of radiation.~\wantclear[\textcolor]{\cite{Therac}}
...
\todo{Is this comment from Rajee still relevant? ``Reword paragraph to clearly show that the problem of bugs is currently being dealt with through extensive testing and making faster and bigger computers. Do dramatic entry of how this is not good enough.''}
