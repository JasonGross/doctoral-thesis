...
\todo{talk about tactics}

\todo{\textcite{Proof2009Geuvers,History2014Harrison}}

\todo{We refer readers to \textcite{CoqArtForward2013Huet} for a comprehensive history of the development of Coq.}
...
\todo{LCF~\cite{LCF2000Gordon,gordon1979edinburgh,gordon1978metalanguage}, Isabelle/HOL~\cite{LCF2019Paulson,Isabelle/Isar2002Wenzel,Isabelle,paulson1994isabelle}, HOL4~\cite{slind2008brief}, HOL Light~\cite{harrison1996hol}, LF~\cite{pfenning1991logic,harper93,Logical2002Pfenning}, Twelf~\cite{pfenning1999system}, Matita~\cite{asperti2007user,Matita2011Asperti}, PVS~\cite{owre1996pvs,PVS1992Owre}, Mizar~\cite{harrison-mizar}, Automath~\cite{wiki:AutoMath,mathematical1970Bruijn,Survey1994deBruijn}}
...
While the correspondence of the unit type to tautologies is relatively trivial, the correspondence of the empty type to\todo{here}
...
For example, we might have a function that returns
\todo{HERE}
%dependent function type ($\Pi$) & & universal quantification ($\forall$) \\
