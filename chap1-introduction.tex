...
\begin{figure}[bht]
  ...
  \pgfplotstableread[col sep=comma]{proof-overhead-no-fiat-crypto.csv}\datatable
  ...
  \begin{axis}[
      ...
      yticklabels from table={\datatable}{Project},
...
%      nodes near coords align=horizontal,
    ...
    \addplot [fill=blue!60]   table [x=Definitions,  meta=Project, col sep=comma, y expr=\coordindex] {proof-overhead-no-fiat-crypto.csv};
    \addplot [fill=orange!60] table [x=Verification, meta=Project, col sep=comma, y expr=\coordindex] {proof-overhead-no-fiat-crypto.csv};
...
\caption{%
  ...
  \todo{Integrate vertical spacing fix from \url{https://tex.stackexchange.com/questions/578270/how-do-i-decrease-vertical-spacing-in-xbar-stacked-pgfplots-charts} once answered}
...
This thesis argues that the problem of \emph{compile-time performance} or \emph{proof-checking performance} is both nontrivial and significantly different from the problem of performance of typical programs.
