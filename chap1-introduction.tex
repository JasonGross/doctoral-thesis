...
\todo{read and cite perf engineering study \textcite{QEDatLarge}}
\todo{read / look into \url{https://dl.acm.org/doi/pdf/10.1145/1297027.1297033}}
\todo{maybe read \url{https://users.cs.northwestern.edu/~robby/courses/322-2013-spring/mytkowicz-wrong-data.pdf}}
\todo{Karl Palmskog: @Jason Gross I saw your post on performance optimization/measurements for proof assistants on Coq-Club. We summarize a lot of work on parallelization/selection for proof assistants in our regression proving papers (ASE 17 \& ISSTA 18): \url{http://users.ece.utexas.edu/~gligoric/papers/CelikETAL17iCoq.pdf} \url{http://users.ece.utexas.edu/~gligoric/papers/PalmskogETAL18piCoq.pdf}}
\todo{read and cite \url{https://leanprover.github.io/papers/tactic.pdf}}
...
\todo{read Grégoire and Leroy's paper from ICFP 2002 \url{https://xavierleroy.org/bibrefs/Gregoire-Leroy-02.html}}
...
\todo{read Andras Kovacs has smalltt at \url{https://github.com/AndrasKovacs/smalltt}}``, which I don't think has been written up anywhere but has nonetheless been influential, both on Idris 2 and on Olle Fredriksson's reimplementation of Sixten at \url{https://github.com/ollef/sixty}''
...
Konrad Slind wrote:
\todo{read \url{https://link.springer.com/chapter/10.1007/3-540-44659-1\_2}}
\todo{\url{https://www.researchgate.net/publication/2390013\_Efficiency\_in\_a\_Fully-Expansive\_Theorem\_Prover}}
\todo{Related to this is work on sound interfaces to external tools, also an enduring topic: \url{https://www.cs.utexas.edu/~kaufmann/itp-trusted-extensions-aug-2010/summary/summary.pdf}}
