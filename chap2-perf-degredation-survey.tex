...
As described in \todo{reference above example about fiat-crypto}, in fiat-crypto, we got exponential slowdown due to this issue, with an estimated overhead of over four thousand millenia of extra typechecking time in the worst examples we were trying to handle.
