...
If the typechecker either decides to unfold \mintinline{coq}{id} before unfolding \mintinline{fact}, or if it performs a breath-first search, then we get speedy performance.
...
\todo{maybe include real-world fiat-crypto example here?}
...
\todo{mention quadratic evar creation https://github.com/coq/coq/issues/8237}
