...
\minortodo{Look into \url{https://people.eecs.berkeley.edu/~necula/papers.html} and \url{http://adam.chlipala.net/papers/StrictTLDI05/} for past work on eliding some parameters}
