...
\todo{ADD PLOT: add plot for just name resolution}
\todo{ADD PLOT: add plot for parsing + internalization}
...
\todo{ADD PLOT: create graph with n evars}
