...
\todo{write text and code with vector example}
\todo{write text and code about rewrite being slow with large opaque proof terms under abstraction barriers (maybe functor exponential laws)}
