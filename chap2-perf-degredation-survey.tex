...
\minortodo{more text to introduce category theory}
\minortodo{how much category theory should we introduce here? how much later?}

We note a couple of important points before including the code for the example:
\begin{itemize}
\item
...
\minortodo{write this text and code better}

\minortodo{what should I say here?}
