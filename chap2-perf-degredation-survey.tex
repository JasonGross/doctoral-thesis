...
\subsubsection{Quadratic Creation of Existential Variables}
...
\coqbug{8237}
\todo{mention quadratic evar creation }
\todo{quadratic application}
\todo{quadratic vm}
\todo{quadratic native}
\todo{quadratic cbv}
\todo{implications of locally nameless vs de bruijn}
