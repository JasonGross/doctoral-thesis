...
When sorting a list, we know that the length of the list and the initial ordering matter; it doesn't matter, though, whether we're sorting a list of integers or colors or names.
