...
\section{Background}\label{sec:perf-failures:story}
\todo{fix phrasing}
...
The thrust of the first argument is that, as I understand it, in most performance domains, solutions to performance bottlenecks are generally either hyper-specialized to the code being optimized or the domain of the algorithm, or else are so general as to be applicable to all performance engineering.
