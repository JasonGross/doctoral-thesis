...
\todoac{[About this entire paragraph] Subtle point here that might benefit from more explanation/example!}
...
Note that fully nameless, i.e., de Bruijn term representations,\todoac{the comma is crossed out, but I think that's wrong} do not suffer from this issue.
