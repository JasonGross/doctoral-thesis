...
\todo{introduce abstraction barrier section}
\todo{talk about packed vs unpacked records}
\todo{talk about opportunity for conversion to make the wrong choice increasing with number of abstraction barriers}
