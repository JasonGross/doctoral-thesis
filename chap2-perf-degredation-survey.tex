...
Then for any concrete number \mintinline{coq}{n} and any concrete description of a Turing machine \mintinline{coq}{TM} which does in fact halt within \mintinline{coq}{n} steps, the term \mintinline{coq}{@eq_refl bool true} can be typecked as a proof of \mintinline{coq}{f TM n = true} because \mintinline{coq}{f TM n} computes to \mintinline{coq}{true}.
