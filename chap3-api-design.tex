  ...
  \begin{figure*}
      \beginTikzpictureStamped{
        ...
        \begin{axis}[xlabel=$n$,
            ...
            \addplot[only marks,color=black] table[x=param-n,y=assert-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{assert}
            \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{build}
            \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{cbn}
            \addplot[only marks,color=black] table[x=param-n,y=destruct-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{destruct}
            \addplot[only marks,color=black] table[x=param-n,y=transaction-user]{performance-experiments/make-destruct-nested-record.txt};
