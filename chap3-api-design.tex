...
\subsection{Nested Σ Types} \label{sec:nested-sigma-types}
  ...
  \end{center}
  If we want to project out the final field, we must write \mintinline{coq}{projT2 (projT2 x)} which, when implicit arguments are included, expands to
  \begin{center}
  ...
  As seen in \autoref{fig:make-destruct-record}, using records mostly solves the issue.
  There is still an untracked quadratic factor in defining the type in the first place; see \todo{cite new bug report}.
...
\end{minted}
  ...
  We can, however, avoid this cost by turning on primitive projections via \mintinline{coq}{Set Primitive Projections} at the top of this block of code:
...
%          \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-sig2.txt};
%          \addlegendentry{cbv (make-nested-sig2)}
%      \end{axis}
%  \end{tikzpicture}
%  \caption{Timing of make-nested-sig2 cbv} \label{fig:timing-make-nested-sig2-cbv}
%\end{figure*}
  ...
  \begin{figure*}
      \beginTikzpictureStamped{
        ...
        \begin{axis}[xlabel=$n$,
            ...
            scaled x ticks=false,
            scaled y ticks=false]
            \addplot[only marks,mark=triangle,color=black] table[x=param-n,y=transaction-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{\mintinline{coq}{Record} command}
%            \addplot[only marks,mark=o,color=black] table[x=param-n,y=assert-user]{performance-experiments/make-destruct-nested-record.txt};
%            \addlegendentry{assert}
%            \addplot[only marks,mark=*,color=black] table[x=param-n,y=cbn-user]{performance-experiments/make-destruct-nested-record.txt};
%            \addlegendentry{cbn}
            ...
            \addlegendentry{\mintinline{coq}{destruct}}
            \addplot[only marks,mark=+,color=black] table[x=param-n,y=build-user]{performance-experiments/make-destruct-nested-record.txt};
            \addlegendentry{building the goal}
        \end{axis}
    \end{tikzpicture}
    \caption{Timing of make-destruct-nested-record} \label{fig:timing-make-destruct-nested-record}
\end{figure*}

%>>> template = r"""\begin{figure*}
%\beginTikzpictureStamped{
%\einput{performance-experiments/%(txt)s.txt}
%}
%\begin{axis}[xlabel=$n$,
%    ylabel=time (s),
%    legend pos=north west,
...
%    scaled x ticks=false,
%    scaled y ticks=false]
%    \addplot[only marks,color=black] table[x=param-n,y=%(y)s-user]{performance-experiments/%(txt)s.txt};
%    \addlegendentry{%(y)s (%(txt)s)}
%    \end{axis}
%\end{tikzpicture}
%\caption{Timing of %(txt)s %(y)s} \label{fig:timing-%(txt)s-%(y)s}
%\end{figure*}"""
%>>>
%>>> params = [{'y':y, 'txt':'%s-nested%s%s%s%s' % (tac, status, kind, num, tacn)}
%    for tacn in ('', '-ltac2')
%    for tac in (('make', 'destruct') if tacn == '' else ('make', ))
%    for status in ('-', '-prim-')
%    for kind in ('prod', 'sig')
%    for num in ('1', '2')
%    for y in {'destruct':['repeat-destruct', 'cbn'], 'make':(['cbv'] if tacn == '' else ['build', 'check', 'type', 'refine'])}[tac]]
%>>> for val in params: print(template % val)

\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prod1.txt};
        \addlegendentry{cbv (make-nested-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod1 cbv} \label{fig:timing-make-nested-prod1-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prod2.txt};
        \addlegendentry{cbv (make-nested-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod2 cbv} \label{fig:timing-make-nested-prod2-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-sig1.txt};
        \addlegendentry{cbv (make-nested-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig1 cbv} \label{fig:timing-make-nested-sig1-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig2.txt}
...
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prim-prod1.txt};
        \addlegendentry{cbv (make-nested-prim-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod1 cbv} \label{fig:timing-make-nested-prim-prod1-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prim-prod2.txt};
        \addlegendentry{cbv (make-nested-prim-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod2 cbv} \label{fig:timing-make-nested-prim-prod2-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prim-sig1.txt};
        \addlegendentry{cbv (make-nested-prim-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig1 cbv} \label{fig:timing-make-nested-prim-sig1-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbv-user]{performance-experiments/make-nested-prim-sig2.txt};
        \addlegendentry{cbv (make-nested-prim-sig2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig2 cbv} \label{fig:timing-make-nested-prim-sig2-cbv}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prod1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prod1.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prod1 repeat-destruct} \label{fig:timing-destruct-nested-prod1-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prod1.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prod1.txt};
        \addlegendentry{cbn (destruct-nested-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prod1 cbn} \label{fig:timing-destruct-nested-prod1-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prod2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prod2.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prod2 repeat-destruct} \label{fig:timing-destruct-nested-prod2-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prod2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prod2.txt};
        \addlegendentry{cbn (destruct-nested-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prod2 cbn} \label{fig:timing-destruct-nested-prod2-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-sig1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-sig1.txt};
        \addlegendentry{repeat-destruct (destruct-nested-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-sig1 repeat-destruct} \label{fig:timing-destruct-nested-sig1-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-sig1.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-sig1.txt};
        \addlegendentry{cbn (destruct-nested-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-sig1 cbn} \label{fig:timing-destruct-nested-sig1-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-sig2.txt};
        \addlegendentry{repeat-destruct (destruct-nested-sig2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-sig2 repeat-destruct} \label{fig:timing-destruct-nested-sig2-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-sig2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-sig2.txt};
        \addlegendentry{cbn (destruct-nested-sig2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-sig2 cbn} \label{fig:timing-destruct-nested-sig2-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-prod1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prim-prod1.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prim-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-prod1 repeat-destruct} \label{fig:timing-destruct-nested-prim-prod1-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-prod1.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prim-prod1.txt};
        \addlegendentry{cbn (destruct-nested-prim-prod1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-prod1 cbn} \label{fig:timing-destruct-nested-prim-prod1-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-prod2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prim-prod2.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prim-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-prod2 repeat-destruct} \label{fig:timing-destruct-nested-prim-prod2-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-prod2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prim-prod2.txt};
        \addlegendentry{cbn (destruct-nested-prim-prod2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-prod2 cbn} \label{fig:timing-destruct-nested-prim-prod2-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-sig1.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prim-sig1.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prim-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-sig1 repeat-destruct} \label{fig:timing-destruct-nested-prim-sig1-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-sig1.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prim-sig1.txt};
        \addlegendentry{cbn (destruct-nested-prim-sig1)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-sig1 cbn} \label{fig:timing-destruct-nested-prim-sig1-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=repeat-destruct-user]{performance-experiments/destruct-nested-prim-sig2.txt};
        \addlegendentry{repeat-destruct (destruct-nested-prim-sig2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-sig2 repeat-destruct} \label{fig:timing-destruct-nested-prim-sig2-repeat-destruct}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/destruct-nested-prim-sig2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=cbn-user]{performance-experiments/destruct-nested-prim-sig2.txt};
        \addlegendentry{cbn (destruct-nested-prim-sig2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of destruct-nested-prim-sig2 cbn} \label{fig:timing-destruct-nested-prim-sig2-cbn}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod1-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prod1-ltac2.txt};
        \addlegendentry{build (make-nested-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod1-ltac2 build} \label{fig:timing-make-nested-prod1-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prod1-ltac2.txt};
        \addlegendentry{check (make-nested-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod1-ltac2 check} \label{fig:timing-make-nested-prod1-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prod1-ltac2.txt};
        \addlegendentry{type (make-nested-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod1-ltac2 type} \label{fig:timing-make-nested-prod1-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prod1-ltac2.txt};
        \addlegendentry{refine (make-nested-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod1-ltac2 refine} \label{fig:timing-make-nested-prod1-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod2-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prod2-ltac2.txt};
        \addlegendentry{build (make-nested-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod2-ltac2 build} \label{fig:timing-make-nested-prod2-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prod2-ltac2.txt};
        \addlegendentry{check (make-nested-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod2-ltac2 check} \label{fig:timing-make-nested-prod2-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prod2-ltac2.txt};
        \addlegendentry{type (make-nested-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod2-ltac2 type} \label{fig:timing-make-nested-prod2-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prod2-ltac2.txt};
        \addlegendentry{refine (make-nested-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prod2-ltac2 refine} \label{fig:timing-make-nested-prod2-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig1-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-sig1-ltac2.txt};
        \addlegendentry{build (make-nested-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig1-ltac2 build} \label{fig:timing-make-nested-sig1-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-sig1-ltac2.txt};
        \addlegendentry{check (make-nested-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig1-ltac2 check} \label{fig:timing-make-nested-sig1-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-sig1-ltac2.txt};
        \addlegendentry{type (make-nested-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig1-ltac2 type} \label{fig:timing-make-nested-sig1-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-sig1-ltac2.txt};
        \addlegendentry{refine (make-nested-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig1-ltac2 refine} \label{fig:timing-make-nested-sig1-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-sig2-ltac2.txt};
        \addlegendentry{build (make-nested-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig2-ltac2 build} \label{fig:timing-make-nested-sig2-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-sig2-ltac2.txt};
        \addlegendentry{check (make-nested-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig2-ltac2 check} \label{fig:timing-make-nested-sig2-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-sig2-ltac2.txt};
        \addlegendentry{type (make-nested-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig2-ltac2 type} \label{fig:timing-make-nested-sig2-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-sig2-ltac2.txt};
        \addlegendentry{refine (make-nested-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-sig2-ltac2 refine} \label{fig:timing-make-nested-sig2-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod1-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prim-prod1-ltac2.txt};
        \addlegendentry{build (make-nested-prim-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod1-ltac2 build} \label{fig:timing-make-nested-prim-prod1-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prim-prod1-ltac2.txt};
        \addlegendentry{check (make-nested-prim-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod1-ltac2 check} \label{fig:timing-make-nested-prim-prod1-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prim-prod1-ltac2.txt};
        \addlegendentry{type (make-nested-prim-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod1-ltac2 type} \label{fig:timing-make-nested-prim-prod1-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prim-prod1-ltac2.txt};
        \addlegendentry{refine (make-nested-prim-prod1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod1-ltac2 refine} \label{fig:timing-make-nested-prim-prod1-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod2-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prim-prod2-ltac2.txt};
        \addlegendentry{build (make-nested-prim-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod2-ltac2 build} \label{fig:timing-make-nested-prim-prod2-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prim-prod2-ltac2.txt};
        \addlegendentry{check (make-nested-prim-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod2-ltac2 check} \label{fig:timing-make-nested-prim-prod2-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prim-prod2-ltac2.txt};
        \addlegendentry{type (make-nested-prim-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod2-ltac2 type} \label{fig:timing-make-nested-prim-prod2-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-prod2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prim-prod2-ltac2.txt};
        \addlegendentry{refine (make-nested-prim-prod2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-prod2-ltac2 refine} \label{fig:timing-make-nested-prim-prod2-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig1-ltac2.txt}
    }
    \begin{axis}[xlabel=$n$,
        ylabel=time (s),
        legend pos=north west,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prim-sig1-ltac2.txt};
        \addlegendentry{build (make-nested-prim-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig1-ltac2 build} \label{fig:timing-make-nested-prim-sig1-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prim-sig1-ltac2.txt};
        \addlegendentry{check (make-nested-prim-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig1-ltac2 check} \label{fig:timing-make-nested-prim-sig1-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prim-sig1-ltac2.txt};
        \addlegendentry{type (make-nested-prim-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig1-ltac2 type} \label{fig:timing-make-nested-prim-sig1-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig1-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prim-sig1-ltac2.txt};
        \addlegendentry{refine (make-nested-prim-sig1-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig1-ltac2 refine} \label{fig:timing-make-nested-prim-sig1-ltac2-refine}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=build-user]{performance-experiments/make-nested-prim-sig2-ltac2.txt};
        \addlegendentry{build (make-nested-prim-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig2-ltac2 build} \label{fig:timing-make-nested-prim-sig2-ltac2-build}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=check-user]{performance-experiments/make-nested-prim-sig2-ltac2.txt};
        \addlegendentry{check (make-nested-prim-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig2-ltac2 check} \label{fig:timing-make-nested-prim-sig2-ltac2-check}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=type-user]{performance-experiments/make-nested-prim-sig2-ltac2.txt};
        \addlegendentry{type (make-nested-prim-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig2-ltac2 type} \label{fig:timing-make-nested-prim-sig2-ltac2-type}
\end{figure*}
\begin{figure*}
    \beginTikzpictureStamped{
        \einput{performance-experiments/make-nested-prim-sig2-ltac2.txt}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        scaled x ticks=false,
        scaled y ticks=false]
        \addplot[only marks,color=black] table[x=param-n,y=refine-user]{performance-experiments/make-nested-prim-sig2-ltac2.txt};
        \addlegendentry{refine (make-nested-prim-sig2-ltac2)}
    \end{axis}
\end{tikzpicture}
\caption{Timing of make-nested-prim-sig2-ltac2 refine} \label{fig:timing-make-nested-prim-sig2-ltac2-refine}
\end{figure*}
  \todo{example}
