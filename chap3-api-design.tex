...
%  >>> params = [{'y':y, 'txt':'%s-nested%s%s%s' % (tac, status, kind, num)}
%      for tac in ('make', 'destruct')
%      for status in ('-', '-prim-')
%      for kind in ('prod', 'sig')
%      for num in ('1', '2')
%      for y in {'destruct':['repeat-destruct', 'cbn'], 'make':['cbv']}[tac]]
%      >>> for val in params: print(template % val)
      ...
      \begin{figure*}
          \beginTikzpictureStamped{
            ...
            \begin{axis}[xlabel=$n$,
                ...
                \addlegendentry{make-nested-prod1}
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{figure*}
        ...
        \begin{axis}[xlabel=$n$,
            ...
            \addlegendentry{make-nested-prod2}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-sig1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-sig2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-prim-prod1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-prim-prod2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-prim-sig1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{make-nested-prim-sig2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prod1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prod2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-sig1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-sig2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prim-prod1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prim-prod2}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prim-sig1}
    \end{axis}
\end{tikzpicture}
...
\begin{figure*}
    ...
    \begin{axis}[xlabel=$n$,
        ...
        \addlegendentry{destruct-nested-prim-sig2}
    \end{axis}
\end{tikzpicture}
