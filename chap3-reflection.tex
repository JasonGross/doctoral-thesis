...
Conventionally, syntax trees are parametric over the value of the \mintinline{coq}{var} parameter, which we may instanitate in various ways to allow variable nodes to hold various kinds of information, and we might define a type for these parametric syntax trees:
\begin{minted}{coq}
