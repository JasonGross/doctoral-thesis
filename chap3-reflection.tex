...
\todoac{Weird to get to this point without introducting polymorphically abstracted expression types. The reader may be wondering where the two instantiated ASTs come from, such that we know they parallel each other.}
