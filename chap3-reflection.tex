...
\minortodo{should the footnote be uncommented here?}
...
\begin{wrapfigure}[4]{r}{\widthof{\texttt{| NatMul (x y : expr) : expr.}}}
%\vspace{-45pt}
\begin{minted}{coq}
Inductive expr :=
| NatO : expr
...
See, e.g.,\todonz{are there other refs? or just kill ``e.g.''} \autocite{PhoasICFP08} for a fuller treatment.
