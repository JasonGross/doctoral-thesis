...
\todo{should we cite this many things here, or remove some of them?}
...
\todo{compare citations with those of \cite[p.~122]{ringer2020qed}}
...
\todo{should this paragraph be here, or above the last one?}
