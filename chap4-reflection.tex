...
\begin{minted}{coq}
Fixpoint is_closed_under (max_index : nat) (e : expr) : bool :=
  match expr with
  | NatO => true
  | NatS e => is_closed_under max_index e
  | NatMul x y => is_closed_under max_index x && is_closed_under max_index y
  | Var n => n <? max_index
  | LetIn v f => is_closed_under max_index v && is_closed_under (S max_index) f
  end.
...
Hence we can prove the theorem \mintinline{coq}{∀ e, is_closed (PHOAS_to_deBruijn e) = true /\ e = deBruijn_to_PHOAS (PHOAS_to_deBruijn e) → Wf e}.
