...
The choices of representation include higher-order abstract syntax (HOAS)~\cite{HOAS}, parametric higher-order abstract syntax (PHOAS)~\cite{PhoasICFP08}, de Bruijn indices~\cite{debruijn1972}, nominal representations~\cite{Nominal2003Pitts}, 
\todo{is this a place to cite POPLMark / encodings more generally?}
...
Using \mintinline{coq}{Wf} to denote the well-formedness predicate, we could prove a theorem
\begin{minted}{coq}
