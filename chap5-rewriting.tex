...
This design, however, is absolutely a mistake, especially given the concession we make in \fullnameref{sec:rewriting-more:pre-reduction:type-codes} to not track\todoac{use ``not to track'' [Jason: I think the current version is better]} enough typing information to avoid all typechecking.
