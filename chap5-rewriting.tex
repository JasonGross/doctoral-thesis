...
It's not even clear a priori that there exists any function which is related to this expression, as \mintinline{coq}{v₁} might contain delayed rewriting which results in different outputs
