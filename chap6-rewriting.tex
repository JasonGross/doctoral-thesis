...
\todo{maybe use enumerate environment here}
...
\subsection{Dependently Typed Pain in Applying Rewrite Rules}\label{sec:rewriting-more:dependently-typed-pain:applying-rewrite-rules}
\begin{itemize}
...
\subsection{Dependently Typed Pain in Indexing Over Types}\label{sec:rewriting-more:dependently-typed-pain:indexing-over-types}
\todo{this subsection}
