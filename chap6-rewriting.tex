...
\todo{does this need to be explained more? How?}
...
\todo{should I discuss why we can't just fuse them?  or how we decide when to put NbE values into rExpr (when they have base types rather than arrow types)?}
