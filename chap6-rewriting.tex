...
This brings us to the question of how to do pattern matching for rewriting with identifiers.
...
\item
  identifers with no polymorphic type information, for use in pattern-matching compilation.
\end{itemize}
