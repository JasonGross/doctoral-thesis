...
The only prior work we've been able to find where abstraction barriers are mentioned for proof developent performance is \textcite{Deep2015Gu}.
...
Following these guidelines, in our experience, tends to both allieveiate proof burden by decoupling and simplifying theorem statements, and also to improve the performance of individual proofs, sometimes by an order of magnitude or more, by avoiding the super-linear scaling laid out in \fullnameref{sec:perf-axes}.
