...
\todo{insert references to  \cref{foot:break-abstraction:example:decision-tree-indexing} in \fullnameref{sec:break-abstraction:example:decision-tree-indexing} (what is \fullnameref{foot:break-abstraction:example:decision-tree-indexing}?) and to \fullnameref{sec:break-abstraction:example:eval-decision-tree}}
...
In this chapter, we will focus primarily on the first of these ways;\todonz{[re ``these ways''] what are you referring to?} while it might seem like a simple question of good design, it turns out that good API design in dependently-typed programming languages is significantly harder than in simply-typed programming languages.
