...
Following these guidelines, in our experience, tends to both alleviate proof burden by decoupling and simplifying theorem statements, and also to improve the performance of individual proofs, sometimes by an order of magnitude or more, by avoiding the superlinear scaling laid out in \fullnameref{sec:perf-axes}.
...
Although preexisting formalizations of category theory in proof assistants abound~\cite{Ahrens2013,megacz-coq-categories,o2004towards,copumpkin/categories,ConCaT%
,CatsInZFC%%fullbib:
...
\label{fig:timing-make-destruct-nested-prim-sig}}
    \caption{%
      ...
      These plots displays both of these methods, and in addition displays the time it takes to run \mintinline{coq}{destruct} to break $x$ into its component fields, as lower bound for how long it takes to prove anything about a nested $\Sigma$ type with $n$ fields.
