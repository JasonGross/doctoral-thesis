...
Last, and most of all, thank you, Adam Chlipala, for your patience, guidance, advice, and wisdom, during the writing of this thesis, and through my research career.
...
\minortodo{thank various other people: Pierre-Marie Pédrot, Rajee Agrawal, friends, Allison Strandberg (incl. for chatting with me about thesis), Matthieu Sozeau, coqdevs more generally, maybe András Kovács on perf discussions, thesis committee, maybe my sister/dad/rest of family}
\minortodo{Rajee or Rajashree?}

\minortodo{cite various grants}
...
\minortodo{should we include acknowledgements from various papers?}
Acknowledgements from the category theory paper:
This work was supported in part by the MIT bigdata@CSAIL initiative, NSF grant CCF-1253229, ONR grant N000141310260, and AFOSR grant FA9550-14-1-0031.
We also thank Benedikt Ahrens, Daniel R.~Grayson, Robert Harper, Bas Spitters, and Edward Z.~Yang for feedback on this paper.

Acknowledgements from the reification by parametricity paper:
