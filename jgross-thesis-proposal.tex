...
\def\completiondate{September---December 2020}
...
\ifthenelse{\boolean{includesigned} \AND \fileexists{\authorsignedpdf.pdf}}{%
...
\ifthenelse{\boolean{includesigned} \AND \fileexists{\supervisorsignedpdf.pdf}}{%
...
\ifthenelse{\boolean{includesigned} \AND \fileexists{\readeronesignedpdf.pdf}}{%
...
\ifthenelse{\boolean{includesigned} \AND \fileexists{\readertwosignedpdf.pdf}}{%
