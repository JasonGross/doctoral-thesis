...
\def\all{all}
\def\nofiles{}
\ifx\files\all \typeout{Including all files.} \else \typeout{Including only \files.} \todo{Make sure to include all files} \includeonly{\files} \fi
\ifx\excludefiles\nofiles \typeout{Exlcuding no files.} \else \typeout{Exlcuding only \excludefiles.} \todo{Make sure to exclude no files} \excludeonly{\excludefiles} \fi
