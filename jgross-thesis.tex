...
\minortodo{Fix spacing in appendix with answer from https://tex.stackexchange.com/questions/577437/how-do-i-move-the-first-line-of-every-paragraph-up-with-everypar-and-vspace}
%\newif\ifskipunparskip
%\skipunparskipfalse
\newcommand{\unparskip}{\vspace{\dimexpr\initialparskip-\parskip\relax}}
%\newcommand{\unparskip}{\ifskipunparskip\else\vspace{\dimexpr\initialparskip-\parskip\relax}not skipped\fi\global\skipunparskipfalse}
\newcommand{\preunparskip}{\setlength{\parskip}{\initialparskip}}%\global\skipunparskiptrue}
...
%\patchcmd{\@afterheading}{\setbox\z@\lastbox}{\setbox\z@\lastbox\global\skipunparskipfalse should not skip}{}{}
