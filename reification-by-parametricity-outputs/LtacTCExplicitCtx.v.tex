...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Class} \coqdocvar{reify\_helper\_cls} (\coqdocvar{var} : \coqdockw{Type}) (\coqdocvar{term} : \coqdocvar{nat})\coqdoceol
\coqdocindent{3.00em}
(\coqdocvar{ctx} : @\coqdocvar{var\_context.var\_context} \coqdocvar{var})\coqdoceol
\coqdocindent{1.00em}
:= \coqdocvar{do\_reify\_helper} : @\coqdocvar{expr} \coqdocvar{var}.\coqdoceol
\coqdocemptyline
\coqdocnoindent
...
@\coqdocvar{reify\_helper\_cls}\coqdoceol
\coqdocindent{14.00em}
\coqdocvar{var} \coqdocvar{f} (@\coqdocvar{var\_context.cons} \coqdocvar{var} \coqdocvar{x} \coqdocvar{not\_x} \coqdocvar{ctx}))\coqdoceol
\coqdocindent{6.50em}
...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Global Hint Extern} 0 (@\coqdocvar{reify\_helper\_cls} \coqdocvar{\_} \coqdocvar{\_} \coqdocvar{\_})\coqdoceol
\coqdocnoindent
\ensuremath{\Rightarrow} (\coqdoctac{intros};\coqdoceol
\coqdocindent{3.00em}
\coqdockw{lazymatch} \coqdockw{goal} \coqdockw{with}\coqdoceol
\coqdocindent{3.00em}
\ensuremath{|} [ \ensuremath{\vdash} @\coqdocvar{reify\_helper\_cls} ?\coqdocvar{var} ?\coqdocvar{term} ?\coqdocvar{ctx} ]\coqdoceol
\coqdocindent{4.00em}
\ensuremath{\Rightarrow} \coqdockw{let} \coqdocvar{res} := \coqdocvar{reify\_helper} \coqdocvar{var} \coqdocvar{term} \coqdocvar{ctx} \coqdoctac{in}\coqdoceol
\coqdocindent{5.50em}
