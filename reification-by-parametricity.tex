...
\footnote{%
  Since then, the performance of \MtacTwo\space has improved significantly, and the other benchmarks have remained mostly unchanged.
  We unfortunately have not had a chance to re-run the benchmarks.
  \minortodo{re-run benchmarks}
}
