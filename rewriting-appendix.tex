...
The \texttt{rewriter} repository has performance data available on the branch \href{https://github.com/mit-plv/rewriter/tree/PhD-Dissertation-2021-perf-data}{\texttt{PhD-Dissertation-2021-perf-data}}, and the \texttt{fiat-crypto} repository has performance data available on the branch \href{https://github.com/mit-plv/fiat-crypto/tree/PhD-Dissertation-2021-perf-data}{\texttt{PhD-Dissertation-2021-perf-data}}.
