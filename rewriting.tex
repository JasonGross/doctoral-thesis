...
We also experimented with the corresponding tactics in the Lean proof assistant, with similarly dissapointing results (\autoref{sec:lean}).
...
Since Coq uses a locally nameless representation~\cite{LocallyNameless} for its terms, evar contexts are necessarily representated as \emph{named} contexts.
