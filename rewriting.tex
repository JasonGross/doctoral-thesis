...
\begin{figure}[btp]
  ...
  \sbox{\NestedBindersSubfloat}{%
    \adjustbox{valign=t}{\resizebox{0.4\textwidth}{!}{\beginTikzpictureStamped[only marks]{
      \einput{rewriting/UnderLetsPlus0.txt}
    }
      ...
      \begin{axis}[xlabel=\# of let binders,ylabel=time (s),ymax=65,
        ...
        \addplot[mark=o,color=red]       table[y=rewrite-strat(bottomup)-regression-exponential-user]{rewriting/UnderLetsPlus0.txt};
        \addplot[mark=triangle,color=red] table[y=rewrite-strat(topdown)-regression-exponential-user]{rewriting/UnderLetsPlus0.txt};
        \addplot[mark=square,color=red]   table[y=setoid-rewrite-regression-cubic-user]{rewriting/UnderLetsPlus0.txt};
        \addplot[mark=+,color=blue]       table[y=Rewrite-for-gen-user]{rewriting/UnderLetsPlus0.txt};
        \addplot[mark=x,color=ForestGreen]table[y=rewriting-user]{rewriting/UnderLetsPlus0.txt};
  ...
  \sbox{\BindersAndRecursiveFunctionsSubfloat}{%
    \adjustbox{valign=t}{\resizebox{0.4\textwidth}{!}{\beginTikzpictureStamped[only marks]{
        \einput{rewriting/LiftLetsMap.txt}
    }
      \pgfplotsset{every axis legend/.append style={
          at={(0.5,-0.2)},
          anchor=north}}
      \begin{axis}[xlabel=$n\cdot m$,ylabel=time (s),scaled x ticks=false,ymax=27,
        ...
        \addplot[mark=o,color=red] table[y=rewrite-strat(bottomup-bottomup)-regression-exponential-user]{rewriting/LiftLetsMap.txt};
        \addplot[mark=triangle,color=red] table[y=rewrite-strat(topdown-bottomup)-regression-exponential-user]{rewriting/LiftLetsMap.txt};
        \addplot[mark=square,color=red] table[y=setoid-rewrite-regression-cubic-user]{rewriting/LiftLetsMap.txt};
        \addplot[mark=+,color=blue] table[y=Rewrite-for-gen-user]{rewriting/LiftLetsMap.txt};
        \addplot[mark=x,color=ForestGreen] table[y=rewriting-user]{rewriting/LiftLetsMap.txt};
        \addplot[mark=*,color=purple] table[y=cps+vm-compute-regression-quadratic-user]{rewriting/LiftLetsMap.txt};
  ...
  \sbox{\NoBindersSubfloat}{%
    ...
    \adjustbox{valign=t}{\resizebox{0.4\textwidth}{!}{\beginTikzpictureStamped[only marks]{
        \einput{rewriting/Plus0Tree.txt}
        \nval
    }
      \pgfplotsset{every axis legend/.append style={
          at={(0.5,-0.2)},
...
\begin{wrapfigure}[16]{r}{0pt}
  \resizebox{0.4\textwidth}{!}{\beginTikzpictureStamped[only marks]{
      \einput{rewriting/SieveOfEratosthenes.txt}
  }
    \pgfplotsset{every axis legend/.append style={
        at={(0.5,-0.3)},
        anchor=north}}
    \begin{axis}[xlabel=upper bound,ylabel=time (s),ymax=65,
      ...
      \addplot[mark=square,color=red]          table[y=simpl-regression-cubic-user]   {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=triangle,color=red]        table[y=cbn-regression-cubic-user]     {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=square*,color=red]         table[y=lazy-regression-quadratic-user]{rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=+,color=blue]              table[y=Rewrite-for-gen-user]          {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=x,color=ForestGreen]       table[y=rewriting-user]                {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=triangle*,color=orange]    table[y=cbv-regression-quadratic-user] {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=*,color=purple]     table[y=vm-compute-regression-quadratic-user] {rewriting/SieveOfEratosthenes.txt};
      \addplot[mark=-,color=red] table[y=native-compute(2)-regression-quadratic-real] {rewriting/SieveOfEratosthenes.txt};
