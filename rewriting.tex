\chapter{\readyforreadingmod{A Framework for Building Verified Partial Evaluators}{intro, appendices, and fusing compiler passes}} \label{ch:rewriting}
