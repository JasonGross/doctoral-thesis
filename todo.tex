...
\newcommand{\minortodo}[1]{%
  \finalwarning{MINOR TODO: \detokenize{#1} on page \thepage\space in file \currfilename}%
  \ifthenelse{\boolean{showminortodos}}{%
    \NowOrAtBeginDocument{\textcolor{red}{[\textbf{MINOR TODO:} #1]}}%
  }{}}%
\newcommand{\minortodofrom}[2]{%
  \finalwarning{MINOR TODO: (FROM #1) \detokenize{#2} on page \thepage\space in file \currfilename}%
  \ifthenelse{\boolean{showminortodos}}{%
...
\newcommand{\minortodoask}[1]{%
  \finalwarning{MINOR QUESTION FOR ADAM: \detokenize{#1} on page \thepage\space in file \currfilename}%
  \ifthenelse{\boolean{showminortodos}}{%
    \NowOrAtBeginDocument{\textcolor{purple}{[\textbf{QUESTION FOR ADAM:} #1]}}%
  }{}}%
\ifthenelse{\boolean{showminortodos}}{
