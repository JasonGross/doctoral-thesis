...
\newcommand{\TextFieldDefault}[2][]{%
  %https://tex.stackexchange.com/a/286374/2066
...
\item
  ...
  \parbox{\remaining}{%
    %\hspace*{0.5in}%
    \setlength{\tempwidth}{\widthof{(last)}+0.5\interwidth+0.5in}%
    \TextFieldDefault[value=\lastname,align=1,name=last name,width=\tempwidth,height=\baselineskip]{}%
    \setlength{\tempwidth}{\widthof{(first)}+\interwidth}%
    \TextFieldDefault[value=\firstname,align=1,name=first name,width=\tempwidth,height=\baselineskip]{}%
    \setlength{\tempwidth}{\widthof{(middle)}+0.5\interwidth+0.5in}%
    \TextFieldDefault[value=\middlename,align=1,name=middle name,width=\tempwidth,height=\baselineskip]{}%
    %\hspace*{0.5in}%
...
\item
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\birthyear,name=birth year,width=0.8in,height=\baselineskip]{}}%
  Year of birth (optional) \uline{\usebox{\tempfieldbox}}
\item
  \setlength{\interwidth}{\widthof{Present mailing address }}%
  \setlength{\tempwidth}{\remaining - \widthof{Present mailing address }}%
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\presentaddressone,name=address line 1,width=\tempwidth,height=\baselineskip]{}}%
  Present mailing address \uline{\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\presentaddresstwo,name=address line 2,width=\tempwidth,height=\baselineskip]{}}%
  \uline{\hspace*{\interwidth}\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\presentaddressthree,name=address line 3,width=\tempwidth,height=\baselineskip]{}}%
  \uline{\hspace*{\interwidth}\usebox{\tempfieldbox}} \\
  \setlength{\interwidth}{\widthof{Future mailing address }}%
  \setlength{\tempwidth}{\remaining - \widthof{Future mailing address }}%
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\futureaddressone,name=future address line 1,width=\tempwidth,height=\baselineskip]{}}%
  Future mailing address \uline{\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\futureaddresstwo,name=future address line 2,width=\tempwidth,height=\baselineskip]{}}%
  \uline{\hspace*{\interwidth}\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\futureaddressthree,name=future address line 3,width=\tempwidth,height=\baselineskip]{}}%
  \uline{\hspace*{\interwidth}\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\futureaddresseffectivedate,name=future address date,width=1in,height=\baselineskip]{}}%
  Effective date of future mailing address \uline{\usebox{\tempfieldbox}} \\
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\homephone,name=home phone,width=1.5in,height=\baselineskip]{}}%
  Home telephone \uline{\usebox{\tempfieldbox}} \hspace*{0.5in}
  \sbox{\tempfieldbox}{\TextFieldDefault[value=\businessphone,name=business phone,width=1.5in,height=\baselineskip]{}}%
